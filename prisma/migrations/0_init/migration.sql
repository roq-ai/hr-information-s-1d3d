...
-- AddForeignKey
ALTER TABLE "vacation_request" ADD CONSTRAINT "vacation_request_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
